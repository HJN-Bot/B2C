    ...
    <Layout>
      <div className="p-4 space-y-6 bg-gray-100">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4">
            {recommendedLessons.map(lesson => (
              <Card 
                key={lesson.id} 
                className="cursor-pointer hover:shadow-lg transition-shadow bg-white shadow-md border border-gray-100" 
        ...
        <div>
          ...
          <Card className="bg-gradient-to-r from-communi-primary/20 to-communi-tertiary/20 border-none shadow-md">
            <CardContent className="p-4">
