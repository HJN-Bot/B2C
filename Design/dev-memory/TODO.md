...
| [2026-05-31 练习页活态打磨](../specs/2026-05-31-practice-live-polish.md) | A2（删顶部状态条/字幕填满/反馈不自动消失/猫猫放慢） | spec 待审阅 |
...
| **A2** | 试用 | 练习页活态打磨：删顶部状态条 / 字幕填满 / 反馈不自动消失 / 猫猫放慢 | [practice-live-polish](../specs/2026-05-31-practice-live-polish.md) | spec 待审阅 |
